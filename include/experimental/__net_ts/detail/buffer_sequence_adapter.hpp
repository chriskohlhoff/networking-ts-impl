...
template <typename Buffer>
class buffer_sequence_adapter<Buffer, std::experimental::net::mutable_buffers_1>
  : buffer_sequence_adapter_base
{
public:
  explicit buffer_sequence_adapter(
      const std::experimental::net::mutable_buffers_1& buffer_sequence)
  {
    init_native_buffer(buffer_, Buffer(buffer_sequence));
    total_buffer_size_ = buffer_sequence.size();
  }
  ...
  static bool all_empty(const std::experimental::net::mutable_buffers_1& buffer_sequence)
  {
    return buffer_sequence.size() == 0;
  }

  static void validate(const std::experimental::net::mutable_buffers_1& buffer_sequence)
  {
    buffer_sequence.data();
  }

  static Buffer first(const std::experimental::net::mutable_buffers_1& buffer_sequence)
  {
    return Buffer(buffer_sequence);
  }
...
template <typename Buffer>
class buffer_sequence_adapter<Buffer, std::experimental::net::const_buffers_1>
  : buffer_sequence_adapter_base
{
public:
  explicit buffer_sequence_adapter(
      const std::experimental::net::const_buffers_1& buffer_sequence)
  {
    init_native_buffer(buffer_, Buffer(buffer_sequence));
    total_buffer_size_ = buffer_sequence.size();
  }
  ...
  static bool all_empty(const std::experimental::net::const_buffers_1& buffer_sequence)
  {
    return buffer_sequence.size() == 0;
  }

  static void validate(const std::experimental::net::const_buffers_1& buffer_sequence)
  {
    buffer_sequence.data();
  }

  static Buffer first(const std::experimental::net::const_buffers_1& buffer_sequence)
  {
    return Buffer(buffer_sequence);
  }
