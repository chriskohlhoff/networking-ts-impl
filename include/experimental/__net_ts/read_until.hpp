...
#include <experimental/__net_ts/basic_streambuf_fwd.hpp>
...
struct is_match_condition
{
  ...
  enum
  {
    value = std::experimental::net::is_function<
        typename std::experimental::net::remove_pointer<T>::type>::value
...
/**
 * @defgroup read_until std::experimental::net::read_until
 *
 ...
 * @code std::string data;
 * std::string n = std::experimental::net::read_until(s,
 *     std::experimental::net::dynamic_buffer(data), boost::regex("\r\n"));
 * std::string line = data.substr(0, n);
 * data.erase(0, n); @endcode
 * After the @c read_until operation completes successfully, the string @c data
 * contains the delimiter:
 ...
 * @code typedef std::experimental::net::buffers_iterator<
 *     std::experimental::net::const_buffers_1> iterator;
 *
 ...
 * ...
 * std::string data;
 * std::experimental::net::read_until(s, data, match_whitespace);
 * @endcode
 *
 ...
 * ...
 * std::string data;
 * std::experimental::net::read_until(s, data, match_char('a'));
 * @endcode
 */
template <typename SyncReadStream,
 ...
 * @code std::experimental::net::streambuf b;
 * std::experimental::net::read_until(s, b, '\n');
 * std::istream is(&b);
 * std::string line;
 ...
 * @code std::experimental::net::streambuf b;
 * std::experimental::net::read_until(s, b, boost::regex("\r\n"));
 * std::istream is(&b);
 * std::string line;
 * std::getline(is, line); @endcode
 * After the @c read_until operation completes successfully, the buffer @c b
 ...
 * @code typedef std::experimental::net::buffers_iterator<
 *     std::experimental::net::streambuf::const_buffers_type> iterator;
 *
 * std::pair<iterator, bool>
 * match_whitespace(iterator begin, iterator end)
 * {
 ...
 * }
 * ...
 * std::experimental::net::streambuf b;
 * std::experimental::net::read_until(s, b, match_whitespace);
 * @endcode
 *
 ...
 * ...
 * std::experimental::net::streambuf b;
 * std::experimental::net::read_until(s, b, match_char('a'));
 * @endcode
 */
...
/*@}*/
/**
 * @defgroup async_read_until std::experimental::net::async_read_until
 *
 ...
 * ...
 * std::string data;
 * std::experimental::net::async_read_until(s, data, match_whitespace, handler);
 * @endcode
 *
 ...
 * ...
 * std::string data;
 * std::experimental::net::async_read_until(s, data, match_char('a'), handler);
 * @endcode
 */
 ...
 * }
 * ...
 * std::experimental::net::async_read_until(s, b, '\n', handler); @endcode
 * After the @c async_read_until operation completes successfully, the buffer
 ...
 * }
 * ...
 * std::experimental::net::async_read_until(s, b, boost::regex("\r\n"), handler); @endcode
 * After the @c async_read_until operation completes successfully, the buffer
 ...
 * ...
 * std::experimental::net::streambuf b;
 * std::experimental::net::async_read_until(s, b, match_whitespace, handler);
 * @endcode
 *
 ...
 * ...
 * std::experimental::net::streambuf b;
 * std::experimental::net::async_read_until(s, b, match_char('a'), handler);
 * @endcode
 */
