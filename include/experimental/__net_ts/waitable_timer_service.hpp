...
#ifndef NET_TS_WAITABLE_TIMER_SERVICE_HPP
#define NET_TS_WAITABLE_TIMER_SERVICE_HPP
...
public:
  ...
  explicit waitable_timer_service(std::experimental::net::io_context& io_context)
  ...
  std::size_t expires_at(implementation_type& impl,
      const time_point& expiry_time, std::error_code& ec)
  {
  ...
  std::size_t expires_after(implementation_type& impl,
      const duration& expiry_time, std::error_code& ec)
  {
...
#endif // NET_TS_WAITABLE_TIMER_SERVICE_HPP
