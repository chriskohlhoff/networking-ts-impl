...
#ifndef NET_TS_STREAM_SOCKET_SERVICE_HPP
#define NET_TS_STREAM_SOCKET_SERVICE_HPP
...
#else
  : public std::experimental::net::detail::service_base<stream_socket_service<Protocol> >
#endif
{
public:
#if defined(GENERATING_DOCUMENTATION)
...
public:
  ...
  explicit stream_socket_service(std::experimental::net::io_context& io_context)
  ...
  {
    if (protocol.type() == NET_TS_OS_DEF(SOCK_STREAM))
...
#endif // NET_TS_STREAM_SOCKET_SERVICE_HPP
