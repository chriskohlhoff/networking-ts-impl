...
public:
  ...
  NET_TS_DECL endpoint(const std::experimental::net::ip::address& addr,
  ...
  std::experimental::net::detail::socket_addr_type* data()
  {
    return &data_.base;
  }

  // Get the underlying endpoint in the native type.
  const std::experimental::net::detail::socket_addr_type* data() const
  {
    return &data_.base;
  }
  ...
  {
    if (is_v4())
      return sizeof(std::experimental::net::detail::sockaddr_in4_type);
    else
      return sizeof(std::experimental::net::detail::sockaddr_in6_type);
  }
  ...
  NET_TS_DECL std::experimental::net::ip::address address() const;

  // Set the IP address associated with the endpoint.
  NET_TS_DECL void address(const std::experimental::net::ip::address& addr);
...
private:
  ...
  union data_union
  {
    std::experimental::net::detail::socket_addr_type base;
    std::experimental::net::detail::sockaddr_in4_type v4;
    std::experimental::net::detail::sockaddr_in6_type v6;
  } data_;
};
