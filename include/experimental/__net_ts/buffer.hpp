...
public:
  ...
  mutable_buffers_1(void* data, std::size_t size) NET_TS_NOEXCEPT
  ...
  explicit mutable_buffers_1(const mutable_buffer& b) NET_TS_NOEXCEPT
    : mutable_buffer(b)
  {
  }
...
public:
  ...
  /// Construct to represent a given memory range.
  const_buffers_1(const void* data, std::size_t size) NET_TS_NOEXCEPT
  ...
  explicit const_buffers_1(const const_buffer& b) NET_TS_NOEXCEPT
    : const_buffer(b)
  {
  }
...
/** @defgroup buffer_size std::experimental::net::buffer_size
 *
 * @brief The std::experimental::net::buffer_size function determines the total number of
 * bytes in a buffer or buffer sequence.
 */
/*@{*/

/// Get the number of bytes in a modifiable buffer.
inline std::size_t buffer_size(const mutable_buffer& b) NET_TS_NOEXCEPT
{
  return b.size();
}

/// Get the number of bytes in a non-modifiable buffer.
inline std::size_t buffer_size(const const_buffer& b) NET_TS_NOEXCEPT
{
  return b.size();
}
...
/// Get the number of bytes in a modifiable buffer.
inline std::size_t buffer_size(const mutable_buffers_1& b) NET_TS_NOEXCEPT
{
  return b.size();
}
...
/// Get the number of bytes in a non-modifiable buffer.
inline std::size_t buffer_size(const const_buffers_1& b) NET_TS_NOEXCEPT
{
  return b.size();
}
...
/** @defgroup buffer_cast std::experimental::net::buffer_cast
 *
 * @brief (Deprecated: Use the @c data() member function.) The
 * std::experimental::net::buffer_cast function is used to obtain a pointer to the
 ...
 * @code std::experimental::net::const_buffer b1 = ...;
 * const unsigned char* p1 = std::experimental::net::buffer_cast<const unsigned char*>(b1);
 * @endcode
 *
 * To access the memory of a modifiable buffer, use:
 * @code std::experimental::net::mutable_buffer b2 = ...;
 * unsigned char* p2 = std::experimental::net::buffer_cast<unsigned char*>(b2);
 * @endcode
 *
 * The std::experimental::net::buffer_cast function permits violations of type safety, so
...
inline PointerToPodType buffer_cast(const mutable_buffer& b) NET_TS_NOEXCEPT
{
...
/// Cast a non-modifiable buffer to a specified pointer to POD type.
template <typename PointerToPodType>
inline PointerToPodType buffer_cast(const const_buffer& b) NET_TS_NOEXCEPT
{
  return static_cast<PointerToPodType>(b.data());
}
...
inline mutable_buffer operator+(const mutable_buffer& b,
    std::size_t start) NET_TS_NOEXCEPT
{
  if (start > b.size())
...
# define NET_TS_MUTABLE_BUFFER mutable_buffers_1
# define NET_TS_CONST_BUFFER const_buffers_1
...
public:
  ...
  {
    return std::experimental::net::buffer(string_, size_);
  }
...
public:
  ...
  const_buffers_type data() const NET_TS_NOEXCEPT
  {
    return std::experimental::net::buffer(vector_, size_);
  }
...
inline std::size_t buffer_copy(const mutable_buffer& target,
    const const_buffer& source) NET_TS_NOEXCEPT
{
 ...
 */
inline std::size_t buffer_copy(const mutable_buffer& target,
    const const_buffers_1& source) NET_TS_NOEXCEPT
{
 ...
 */
inline std::size_t buffer_copy(const mutable_buffer& target,
    const mutable_buffer& source) NET_TS_NOEXCEPT
{
 ...
 */
inline std::size_t buffer_copy(const mutable_buffer& target,
    const mutable_buffers_1& source) NET_TS_NOEXCEPT
{
  return buffer_copy(target, const_buffer(source));
}
...
std::size_t buffer_copy_to_sequence(TargetIterator target_begin,
    TargetIterator target_end, const const_buffer& source) NET_TS_NOEXCEPT
{
  std::size_t total_bytes_copied = 0;
    ...
    >::type* = 0) NET_TS_NOEXCEPT
{
  return detail::buffer_copy_to_sequence(
      ...
      std::experimental::net::buffer_sequence_end(target), source);
}
